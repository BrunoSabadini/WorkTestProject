...
import 'package:work_project/l10n/internationalization_en.dart';
import 'internationalization_es.dart';
import 'internationalization_pt.dart';
...
abstract class PedroLouco {
  ...
  static const LocalizationsDelegate<PedroLouco> delegate =
      _PedroLoucoDelegate();
...
PedroLouco lookupPedroLouco(Locale locale) {
  ...
  switch (locale.languageCode) {
    case 'en':
      return InternationalizationEn();
    case 'es':
      return InternationalizationEs();
    case 'pt':
      return InternationalizationPt();
  }
